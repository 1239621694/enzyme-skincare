        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="font-heading text-xl font-bold text-white">
              {BUSINESS_INFO.storeName}
            </Link>
            <p className="mt-2 text-sm text-neutral-400 leading-relaxed">
              Professional skincare by {BUSINESS_INFO.brandName}. Science-backed formulations for healthier-looking skin.
            </p>
          </div>
        ...
        <div className="mt-10 pt-8 border-t border-neutral-800">
          <div className="max-w-4xl">
            ...
            <div className="text-xs text-neutral-400 space-y-1 leading-relaxed">
              <p><strong className="text-neutral-300">Company:</strong> {BUSINESS_INFO.storeName}</p>
              <p><strong className="text-neutral-300">Legal Name:</strong> {BUSINESS_INFO.legalNameEN} ({BUSINESS_INFO.legalNameCN})</p>
              <p><strong className="text-neutral-300">Registration No.:</strong> {BUSINESS_INFO.registrationNumber}</p>
              <p><strong className="text-neutral-300">Registered Address:</strong> {BUSINESS_INFO.registeredAddressEN}</p>
              <p><strong className="text-neutral-300">Email:</strong> <a href={`mailto:${BUSINESS_INFO.supportEmail}`} className="text-neutral-400 hover:text-white transition-colors">{BUSINESS_INFO.supportEmail}</a></p>
