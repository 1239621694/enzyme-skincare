...
const WHATSAPP_URL = "https://wa.me/8613980551004";
const WHATSAPP_TEXT = "Hi! I have a question about your skincare products.";

export function WhatsAppFeed() {
  return (
    <section className="section-padding bg-gradient-to-r from-green-50 to-primary-50">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-lg mx-auto">
          ...
          <Link
            ...
            className="mt-6 inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-green-500 text-white font-medium hover:bg-green-600 transition-colors"
          >
