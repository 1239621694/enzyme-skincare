...
export const ALL_PRODUCTS: ProductData[] = [
  {
    ...
    howToUse: "1. Cleanse your face. 2. Mix one bottle of lotion with one bottle of powder. 3. Apply evenly with the silicone brush. 4. Leave on for 10-20 minutes. 5. Rinse thoroughly. Apply a medical-grade recovery mask or a hydrating sheet mask immediately after the treatment. Avoid masks containing exfoliating acids or other intensive active ingredients.\n\nFor a complete post-treatment skincare routine, we recommend pairing with Enzyme Skincare Copper Peptide Repair Freeze-Dried Powder and Enzyme Skincare Rose Brightening Fermented Mask. These products are designed to complement the enzyme treatment and help maintain skin hydration and comfort after use.",
  ...
  },
  {
    ...
    name: "Enzyme Skincare Rose Brightening Fermented Face Mask",
  ...
  },
  {
    ...
    name: "Enzyme Skincare Blue Copper Peptide Repair & Anti-Wrinkle Freeze-Dried Powder Set",
