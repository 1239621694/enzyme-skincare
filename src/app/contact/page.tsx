...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Message sent successfully! We will respond within 1–2 business days.");
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12">
      <div className="max-w-5xl mx-auto">
        <h1 className="font-heading text-[clamp(1.8rem,3.5vw,3rem)] font-bold text-neutral-800 mb-3">Contact Enzyme Skincare</h1>
        <p className="text-neutral-600 max-w-2xl mb-10">
          Our customer care team is available to assist with product information, order support, shipping, returns and skincare-use questions.
        </p>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="p-6 bg-neutral-50 rounded-xl border border-neutral-200">
              ...
              <dl className="space-y-3 text-sm text-neutral-600">
                <div><dt className="font-semibold text-neutral-800">Customer Support</dt><dd><a href={`mailto:${BUSINESS_INFO.supportEmail}`} className="text-primary-600 hover:text-primary-700">{BUSINESS_INFO.supportEmail}</a></dd></div>
                <div><dt className="font-semibold text-neutral-800">Legal / Privacy</dt><dd><a href={`mailto:${BUSINESS_INFO.legalEmail}`} className="text-primary-600 hover:text-primary-700">{BUSINESS_INFO.legalEmail}</a></dd></div>
            ...
            <div className="p-6 bg-neutral-50 rounded-xl border border-neutral-200">
              ...
              <p className="text-sm text-neutral-600 mb-3">Message us on WhatsApp for product inquiries.</p>
            ...
            <div className="p-6 bg-neutral-50 rounded-xl border border-neutral-200">
              <h2 className="font-semibold text-neutral-800 mb-2">Return Address</h2>
              <p className="text-sm text-neutral-600">Please contact us for a return authorization before sending any items. Our return address is in Chengdu, China.</p>
            </div>
          </div>
        </div>
      </div>
