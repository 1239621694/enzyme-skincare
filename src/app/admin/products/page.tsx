...
export default async function AdminProductsPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 font-heading text-2xl font-bold">Products ({products.length})</h1>
      <div className="overflow-hidden rounded-xl border bg-white">
        <table className="w-full text-sm">
          ...
          <tbody>
            {products.length === 0 && <tr><td colSpan={5} className="p-6 text-center text-neutral-400">No products yet</td></tr>}
            {products.map((p: any) => {
