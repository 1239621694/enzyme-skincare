...
export default async function AdminReportsPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 font-heading text-2xl font-bold">Reports</h1>
      <div className="grid grid-cols-4 gap-4 mb-8">
        ...
        <div className="rounded-xl border bg-white p-5"><p className="text-sm text-neutral-500">Revenue</p><p className="mt-1 text-2xl font-bold">${totalRevenue.toFixed(2)}</p></div>
